...
describe("purchase-derived coffee costs", () => {
  it("uses only confirmed purchases in the weighted unit cost", () => {
    const cost = weightedGreenUnitCost([
      { status: "confirmed", total_amount: "1000.00", received_weight_kg: "10.000" },
      { status: "confirmed", total_amount: "3000.00", received_weight_kg: "20.000" },
      { status: "draft", total_amount: "9999.00", received_weight_kg: "1.000" },
      { status: "void", total_amount: "9999.00", received_weight_kg: "1.000" },
    ]);
  ...
  it("does not infer a cost without a valid confirmed purchase", () => {
