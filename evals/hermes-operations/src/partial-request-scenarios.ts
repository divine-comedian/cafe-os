...
export const partialRequestScenarios: EvalScenario[] = [
  {
    id: "partial_es_green_lot_missing_variety",
    locale: "es-MX",
    description: "Ask for a required variety, then carry the answer into an exact lot proposal and confirmation.",
    turns: [
      {
        prompt: "Anota un lote nuevo: se llama Lote feria y viene de Chiapas. Es todo lo que tengo por ahora.",
        expect: {
          allowedTools: [], maxToolCalls: 0, maxApiCalls: 2, mutationCount: 0,
          responsePatterns: ["variedad"],
          routerRequiresUserInput: ["variety"], terminalReason: "needs_input",
        },
      },
      {
        prompt: "La variedad es CATURRA. Prepara el registro con lo que ya te di.",
        expect: {
          ...
          responsePatterns: ["Lote feria", "CATURRA", "conf[ií]rm"],
          toolCallContains: [{ name: "create_green_coffee_lot", arguments: { name: "Lote feria", origin: "Chiapas", variety: "CATURRA" } }],
          toolCallOmits: [{ name: "create_green_coffee_lot", fields: ["notes"] }],
      ...
      },
      {
        ...
        expect: {
          ...
          stateContains: [{ table: "green_coffee_lots", fields: { name: "Lote feria", origin: "chiapas", variety: "caturra" } }],
        },
      },
    ],
  },
  {
    ...
    turns: [
      ...
      {
        prompt: "Confirmed. Save exactly that purchase draft.",
        expect: {
          requiredTools: ["create_purchase"], allowedTools: ["create_purchase"],
          minToolCalls: 1, maxToolCalls: 1, maxApiCalls: 2, mutationCount: 1,
          confirmationTools: ["create_purchase"], terminalReason: "completed",
          stateContains: [{ table: "purchases", fields: { provider_id: IDS.fincaNorte, green_coffee_lot_id: IDS.greenLot, received_weight_kg: "22", total_amount: "4200", currency: "MXN", payment_method: "transfer", status: "draft" } }],
        },
      },
    ],
  },
    ...
    turns: [
      ...
      },
      {
        ...
        expect: {
          ...
          minToolCalls: 1, maxToolCalls: 1, maxApiCalls: 2, mutationCount: 1,
          confirmationTools: ["create_purchase"], terminalReason: "completed",
          stateContains: [{ table: "purchases", fields: { provider_id: IDS.cafeSierra, green_coffee_lot_id: IDS.greenLot, received_weight_kg: "18", currency: "MXN", status: "draft" } }],
        },
      },
    ],
  },
    ...
    turns: [
      {
        ...
        expect: {
          ...
          toolCallContains: [{ name: "create_provider", arguments: { name: "Monte Claro" } }],
          toolCallOmits: [{ name: "create_provider", fields: ["region", "notes"] }],
          terminalReason: "needs_confirmation",
        },
      },
      {
    ...
    turns: [
      ...
      },
      {
        ...
        expect: {
          ...
          minToolCalls: 1, maxToolCalls: 1, maxApiCalls: 2, mutationCount: 1,
          confirmationTools: ["create_purchase"], terminalReason: "completed",
          stateContains: [{ table: "purchases", fields: { provider_id: IDS.cafeSierra, green_coffee_lot_id: IDS.greenLot, received_weight_kg: "20", currency: "MXN", status: "draft" } }],
        },
      },
    ],
  },
