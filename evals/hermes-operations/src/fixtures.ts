...
export const IDS = {
  ...
  olderPurchase: "33333333-3333-4333-8333-333333333333",
  recentPurchase: "44444444-4444-4444-8444-444444444444",
...
export function coreFixture(): CafeState {
  return structuredClone({
    ...
    purchases: [
      { id: IDS.olderPurchase, provider_id: IDS.cafeSierra, green_coffee_lot_id: IDS.greenLot, purchased_at: "2026-09-01", received_weight_kg: "60.000", total_amount: "11400.00", currency: "MXN", payment_method: "transferencia", notes: null, document_path: null },
      { id: IDS.recentPurchase, provider_id: IDS.cafeSierra, green_coffee_lot_id: IDS.greenLot, purchased_at: "2026-09-14", received_weight_kg: "50.000", total_amount: "12500.00", currency: "MXN", payment_method: "efectivo", notes: "pendiente de revisar recibo", document_path: null },
    ],
    green_coffee_lots: [
